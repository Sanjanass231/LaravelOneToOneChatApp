<div>
    <div style="overscroll-behavior: none;">
      <div
        class="fixed w-full bg-blue-600 text-white h-16 pt-2 text-white flex justify-between shadow-md"
        ...
        @else
            <div class="clearfix w-4/4">
               <div class="text-right">
                <p class="bg-blue-600 text-white mx-4 my-2 p-2 rounded-lg inline-block ">{{$message['message']}}</p>
...
<form wire:submit="sendMessage()">
    <div class="fixed w-full flex justify-between bg-blue-200" style="bottom: 0px;">
      <textarea
